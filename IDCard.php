...
<div id="wrapper">
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
					...
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#"> </a></h2>
														<p align="right"><a href="StaffHome.php"><strong> Go Back  </strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="Login.php"><strong>Logout</strong></a></p>
               ...
               <!-- The form below allows to view all students of a class by selecting  class and division-->
					
					
						
				      
				 <form action="viewid.php" method="post">
  <table align="center" width="371" height="176" border="1">
  <tr>
    <td><span class="style2">
      <label><span class="style7">Enter Class </span></label>
      <span class="style7">    :</span></span></td>
  ...
  <tr>
   ...
   <tr>
	 ...
	 <td> <a href="StaffHome.php">Cancel</a> </td>
   </tr>
</table>
</form>
