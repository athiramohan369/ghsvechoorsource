			...
			<div id="page-bgbtm">
				<div id="page-content">
					...
					<div id="content">
						...
						<div class="post">
							<h2 class="title"><a href="#">school library </a></h2>
							<p class="meta"></p>
							<div class="entry">
								<p><img src="images/libr.jpg" width="628" height="250" alt="" class="border" /><span class="style1">The school library is accessible for all the students of the school.Our qualified librarians guide the students in reference skills and efficient reading habits.There are sections devoted to text books and reference books, Board Examination Reviews, fiction, drama, poetry, books on travel, environment, animal care, life skills, disaster management, and many other topics. There are also hobby-related and activity-oriented books that promote self-study and learning by doing.</span></p>
						  </div>
						</div>
