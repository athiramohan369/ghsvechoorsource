...
<div id="wrapper">
	...
	$title=$row["title"];
		   ...
		   //echo "<a href='N.php?NewsId=$nid&Description=$des&Title=$tit'>".$row['Title']. " </a><br>";
		  echo "<a href='News.php?nid=$nid&description=$description&title=$title'>".$row['title']. " </a><br>";

		 //echo "<p><h4><font color='green'>--><a href='news.php'></font><font color='red'>".$row['title']."</font><br/></h4></p>";
			// echo "<a href='news.php?'>".$row['title']. " </a><br>";
		}
