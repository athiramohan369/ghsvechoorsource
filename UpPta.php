...
<!-- The code below inserts the PTA details into the pta table of school database -->
...
$desig=$_POST["desig"];                                      //all inserted details are stored into variables
$name=$_POST["name"];
$hname=$_POST["hname"];
$street=$_POST["street"];
$city=$_POST["city"];
...
// all details are inserted into pta table of database




$q="insert into pta(desig,name,hname,street,city,pin,email,phone)values('".$desig."','".$name."','".$hname."','".$street."','".$city."','".$pin."','".$email."','".$phone."')";
mysql_query($q);
header("Location: PtaView.php");
}
?>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#"> </a></h2>
														<p align="right"><a href="PtaView.php"><strong> Go Back  </strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="Login.php"><strong>Logout</strong></a></p>
                  ...
                  <!-- The form below is used for inserting pta details  -->
								...
								<p>
				          <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Update PTA Details </h2>
				          <form name="UpPta" method="post" action="">
				          <table class="one" align="center" width="450" border="2">
		<tr><td>&nbsp;</td>
		</tr>
				      <tr><td><b>Designation</b></td><td><input type="text" name="desig" size="45" /></td></tr>

		<tr><td><b>Name</b></td><td><input type="text" name="name" id="name" onBlur="chk();" onKeyPress="return onlyAlphabets(event,this);"  size="45" /></td><td>&nbsp; &nbsp;</td><td width="138"> <span id="nam"></span></td>
			  </tr>
		      ...
		      <tr><td><b>Mobile</b></td><td><input type="text" name="phone" onKeyPress="return onlyNumbers(event,this);" maxlength="10" size="45" required /></td></tr>
		      
		<tr><td><input type="submit" value="Create" onClick="alert('Click to submit');" name="submit"/>
		<th><a href="PtaView.php"><font color="#0066FF"><b>Cancel</b></font></a></th></td></tr>
		</table>
		</form>
