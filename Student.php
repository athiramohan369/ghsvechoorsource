		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#"> </a></h2>							<p align="right"><a href="AdminHome.php"><strong> Go Back</strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="Login.php"><strong> Logout</strong></a></p>
				 ...
				 <p align="center"><a href="excelphoto.php" class="style2 class2"><strong>Students' Excel File and Photo Upload</strong></a></p>

								
							  <p align="center"><a href="ViewStudent.php" class="class2"><strong>View Student Details</strong></a></p>

    <p align="center"><a href="DetailsStudent.php" class="class2"><strong>Student Registration</strong></a></p>
