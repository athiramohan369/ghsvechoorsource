				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
				            ...
				            <p align="center" class="style5">
                            <p align="center" class="style5"><strong><a href="UpPta.php" class="class2">Register PTA member details</a></strong></p>

    <p align="center"><span class="style5"><strong><a href="ViewPta.php" class="class2">View PTA Details</a></strong></span></p>
