		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				$('#slider').slidertron({
					...
					<p align="right"><a href="AdminHome.php"><strong> Go Back  </strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="Login.php"><strong>Logout</strong></a></p>
...
<!-- The form below shows the details of all Principals till date and also we can edit the details if needed   -->
								...
								<form name="ViewPrincipal" method="post" action="">
		
		  <p>&nbsp;</p>
		  <table align="right" width="550" border="2" class="one">
		<tr><th><span class="style2">Name</span></th>
		<th><span class="style2">E-mail id</span></th>
		<th><span class="style2">Designation</span></th>
...
<!-- The details from principal table are taken and shown in a form   -->
...
<td><?php echo $designation; ?></td><td><?php echo $status; ?></td>
<td><?php echo "<a href='EditDetails.php?name=$name&email=$email&designation=$designation&status=$status'>Edit</a>"; ?>
</td></tr>
...
<div id="footer">
	<p>Copyright (c) 2016 . All rights reserved. Mzaintained by RIT, Pampady.</p>
</div>
<!-- end #footer -->
</body>
</html>
