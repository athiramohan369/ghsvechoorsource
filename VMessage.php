					...
					<div id="content">
						<div class="post">
							...
							<div class="entry">
						      ...
						      <p align="center"> <span class="style1">Your Inbox</span>
						      
						      <form name="ViewStaff" method="post" action="">
		
		  <p>&nbsp;</p>
		  <table align="right" width="550" border="2" class="one">
		<tr><th class="style3">Date</th><th class="style3">From</th>
		</tr>
<?php 
	require_once("connect.php");
       $sq="SELECT * FROM message order by Date desc";
	   $rc=mysql_query($sq);
	   while($row=mysql_fetch_array($rc))
	{
		$id=$row[0];
		$tym=$row[1];
	$dat = date( 'd-m-Y', strtotime($tym));
		...
		<tr><td><?php echo $dat; ?></td> <?php  echo "<td><a href='IndMsg.php?id=$id'>$id</a></td>";  ?>
</tr> 
