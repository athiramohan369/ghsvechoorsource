		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#"> </a></h2><p align="right"><a href="Login.php"><strong> Logout</strong></a></p>
							<p class="meta"></p>
							<div class="entry">
								<p>
						...
						<!-- The below links are used by admin in home page  -->
				            ...
				            <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style1">Welcome Admin</span> 
				              </p>
				            </h2>
				            <p align="center">&nbsp;</p>
				            <p align="center">&nbsp;</p>
							 <p align="center"><a href="AdminProfile.php" class="class2 style2">Update Admin's Profile</a></p>


				            <p align="center"><a href="TeacherView.php" class="class2 style2">Update or View Teacher Details</a></p>
				            <p align="center"><a href="Student.php" class="class2 style2">Update or View Student Details</a></p>
	    <p align="center"><a href="UpNews.php" class="class2 style2">Update News</a></p>

	    <p align="center"><a href="UpGal.php" class="class2 style2">Update Gallery</a></p>

	    <p align="center"><a href="PtaView.php" class="class2 style2">PTA Details</a></p>

  <p align="center"><a href="VMessage.php" class="class2 style2">View Messages</a></p>
