...
<!-- The code below inserts the Principal details into the principal table of school database -->
...
// all details are inserted into principal table of database




$q="insert into principal(name,hname,street,city,state,pin,dob,doj,email,phone,qualification,designation,photo,status)values('".$name1."','".$hname1."','".$street1."','".$city1."','".$state1."','".$pin1."','".$dob1."','".$doj1."','".$email1."','".$phone1."','".$qualification1."','".$designation1."','".$image_name."','".$status1."')";
mysql_query($q);
		...
		<div id="page-bgtop">
				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							...
							<p align="right"><a href="AdminProfile.php"><strong> Go Back  </strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="Login.php"><strong>Logout</strong></a></p>
							<p class="meta"></p>
							<div class="entry">
								<p>
										...
										<!-- Form for inserting principal details is given below -->
	
								
								  
							  
								  <form name="UpdateAdmin" method="post" action="UpdateAdmin.php"  enctype="multipart/form-data">
		  ...
		  <div align="left">
		   ...
		   <tr><td><b>Status</b></td><td><label>
		      ...
		      <tr><td><input type="submit" value="Insert" onClick="alert('Click to submit');" name="submit"/>	          <td><a href="AdminHome.php" ><font color="#0066FF"><b>Cancel</b></font></a></td></td></tr>
