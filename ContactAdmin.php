				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							...
							<p align="right"><a href="TeacherHome.php"><strong>Go Back</strong></a></p>
							<p class="meta"></p>
							<div class="entry">
								<p>
							  <p align="center">
					...
					<!-- The code below gives links to send and view messages to and from admin   -->
					  
							  
							  
							  
							  <p align="center"><span class="style2"><span class="style3"><span class="style4"><span class="style5"><a href="AddMessage.php"  class="class2">Send Message </a></span></span></span></span></p>
	 <p align="center"><span class="style5"><strong><a href="ViewReply.php"  class="class2">View Message </a></strong></span></p>
