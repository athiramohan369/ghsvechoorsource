				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							...
							<p class="title">&nbsp;</p>
							<p align="right"><a href="TeacherHome.php"><strong>Go Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a><a href="Login.php"><strong>Logout</strong></a></p>
							<p class="meta"></p>
							<div class="entry">
...
require_once("connect.php");
	   ...
	   $rc=mysql_query($sq);
			...
			<form action="TViewStudent.php" method="post">
...
?>
    ...
    <form action="TViewClass.php" method="post">
  ...
  <tr>
   ...
   <tr>
	 ...
	 <td> <a href="TeacherHome.php">Cancel</a> </td>
   </tr>
</table>
</form>
