		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				$('#slider').slidertron({
					...
					<div id="content">
						<div class="post">
							<h2 class="title"><a href="#"> </a></h2><p align="right"><a href="Student.php"><strong> Go Back  </strong></a>&nbsp; &nbsp;&nbsp; &nbsp;<a href="Login.php"><strong> Logout</strong></a></p>
							<p class="meta"></p>
							<div class="entry">
								<p>
...
<!-- The below given links facilitate updating the student details of the entire class on a single click   -->
				            ...
				            <h2 align="center"><span class="style1">Update student table </span> 
				              </p>
				            </h2>
				            <p align="center">&nbsp;</p>
				            <p align="center">&nbsp;</p>
							 <p align="center"><a href="exup.php" class="class2 style2">Upload Excel File</a></p>

				            <p align="center"><a href="photoupload.php" class="class2 style2">Upload Zip Folder of Photos</a></p>
